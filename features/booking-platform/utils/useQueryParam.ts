...
// mounted — no effect + setState cascade needed. Copied from
// service-platform (not imported from it) so this feature module stays
// self-contained — see the .theme-mumsa comment in globals.css.
