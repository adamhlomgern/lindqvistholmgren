  ...
  return (
    <>
      <PageHero
        ...
        visual={
          <div className="relative mx-auto -mb-16 w-[220px] rotate-3 sm:-mb-20 sm:w-[260px] lg:mx-0 lg:mb-0 lg:w-[270px]">
            {/* Cropped to roughly the top half on small screens, with a
                hard-cut (unrounded) bottom edge pulled down past the hero
                section so it reads as a card sticking up out of the section
                below rather than a long strip of app stacked under the hero
                copy. Full screenshot and normal rounded corners on desktop,
                where it sits beside the text instead of above the next
                section. */}
            <div className="animate-float relative h-[210px] overflow-hidden rounded-t-[1.75rem] border border-bone/10 shadow-2xl shadow-charcoal/50 ring-1 ring-bone/5 sm:h-[250px] lg:h-[493px] lg:rounded-[1.75rem]">
              <Image
